        ...
        <div className="col-3">
            <div className="box-checkout">
                ...
                <div className="input-group">
                    ...
                    <input type="text" id="fone" onChange={(e) => setFone(e.target.value)} ></input>
                </div>
            </div>
        </div>
        <div className="col-3">
            <div className="box-checkout">
                ...
                <div className="input-group">
                    <p>Endereço</p>
                    <input type="text" id="endereco" onChange={(e) => setEndereco(e.target.value)} ></input>
                </div>
                <div className="input-group">
                    <p>Bairro</p>
                    <input type="text" id="bairro" onChange={(e) => setBairro(e.target.value)} ></input>
                </div>
                <div className="input-group">
                    <p>Cidade</p>
                ...
                <div className="input-group">
                    ...
                    -<select id="uf" onChange={(e) => setUf(e.target.value)}>
                        ...
                        <option value="DF">Distrito Feral</option>
